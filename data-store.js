window.uiStore = {
  auth: {
    ...
    users: [
      { id: "u1", name: "Admin User", email: "a@io.com", role: "admin", redirect: "dashboard-admin.html" },
      { id: "u2", name: "Learner User", email: "l@io.com", role: "learner", redirect: "dashboard-learner.html" },
      { id: "u3", name: "Manager User", email: "m@io.com", role: "instructor", displayRole: "manager", redirect: "dashboard-manager.html" }
    ]
  },
  login: {
